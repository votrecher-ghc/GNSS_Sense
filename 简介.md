...
最后更新：2026-08-10 09:50:27 +08:00
...
截至 2026-08-10，给下一个 agent 的最新交接重点：
...
5. 最近的论文图格式修复：`scenario_authentication_roc.pdf` 和 `scenario_authentication_metrics_bar.pdf` 已统一为固定 `1200 x 900 pt` PDF 页面；相关导出逻辑在 `export_paper_figures_data_driven.m` 中。
